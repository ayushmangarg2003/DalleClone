...
const FormField = ({labelname, type, name, value, placeholder,handleChange, handleSurpriseMe, isSurpriseMe}) => {
  return (
    <div>
      ...
      required className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#6469ff] focum:border-[#6469ff] outline-none block w-full p-3' />
    </div>
  )
}
